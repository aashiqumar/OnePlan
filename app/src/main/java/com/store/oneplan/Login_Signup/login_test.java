...
public class login_test extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            finish();
            startActivity(new Intent(login_test.this, MainActivity.class));
        }
        ...
        foregetPasswrod.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(login_test.this, forgetPassword.class));
        ...
        btnGoToSignup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(login_test.this, signup.class));
